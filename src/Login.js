    ...
    <div style={S.wrap}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .inp:focus{border-color:rgba(212,175,55,0.6)!important;box-shadow:0 0 0 3px rgba(212,175,55,0.1)!important}
        .btn-main:hover{transform:translateY(-2px);box-shadow:0 12px 40px rgba(212,175,55,0.4)!important}
        .btn-main:active{transform:translateY(0)}
      `}</style>

      {/* Animated background orbs */}
      <div style={{position:"fixed",inset:0,overflow:"hidden",zIndex:0}}>
        <div style={{position:"absolute",width:600,height:600,borderRadius:"50%",background:"radial-gradient(circle,rgba(212,175,55,0.08) 0%,transparent 70%)",top:"10%",left:"50%",transform:"translateX(-50%)",animation:"pulse 6s ease-in-out infinite"}}/>
        <div style={{position:"absolute",width:300,height:300,borderRadius:"50%",background:"radial-gradient(circle,rgba(212,175,55,0.05) 0%,transparent 70%)",bottom:"20%",left:"10%",animation:"pulse 8s ease-in-out infinite 2s"}}/>
        <div style={{position:"absolute",width:200,height:200,borderRadius:"50%",background:"radial-gradient(circle,rgba(212,175,55,0.06) 0%,transparent 70%)",top:"30%",right:"10%",animation:"pulse 7s ease-in-out infinite 1s"}}/>
      ...
      <div style={S.container}>
        ...
        <div style={{textAlign:"center",marginBottom:40,animation:"fadeUp 0.8s ease both"}}>
          ...
          <div style={{position:"relative",width:80,height:80,margin:"0 auto 24px",animation:"float 4s ease-in-out infinite"}}>
            <svg viewBox="0 0 80 80" width="80" height="80">
              ...
              <line x1="28" y1="37" x2="50" y2="37" stroke="#D4AF37" strokeWidth="1" strokeLinecap="round" opacity="0.5"/>
              <line x1="28" y1="44" x2="48" y2="44" stroke="#D4AF37" strokeWidth="1" strokeLinecap="round" opacity="0.5"/>
          ...
          <h1 style={{
            ...
            fontWeight:300,
            letterSpacing:8,
            background:"linear-gradient(135deg,#F5D76E 0%,#D4AF37 40%,#F5D76E 60%,#B8860B 100%)",
          ...
          <p style={{fontFamily:"'DM Sans',sans-serif",fontSize:13,color:"#6a5d40",letterSpacing:3,textTransform:"uppercase",fontWeight:300}}>
            Gestion de factures
          </p>
        </div>
        ...
        <div style={{...S.card,animation:"fadeUp 0.8s ease 0.2s both"}}>
          ...
          {/* Tabs */}
          <div style={{display:"flex",marginBottom:28,background:"rgba(212,175,55,0.04)",borderRadius:10,padding:3}}>
            {["login","signup"].map(m => (
              <button key={m} style={{
                flex:1,padding:"10px 0",borderRadius:8,border:"none",cursor:"pointer",
                fontFamily:"'DM Sans',sans-serif",fontSize:13,letterSpacing:1,fontWeight:500,
                transition:"all 0.3s",
                background:mode===m?"linear-gradient(135deg,#D4AF37,#F5D76E)":"transparent",
                color:mode===m?"#0D0D08":"#6a5d40",
              }} onClick={() => setMode(m)}>
          ...
          {[
            ...
            <div key={label} style={{marginBottom:16}}>
              <label style={{display:"block",fontFamily:"'DM Sans',sans-serif",fontSize:11,color:"#6a5d40",letterSpacing:2,textTransform:"uppercase",marginBottom:8}}>{label}</label>
              <input
                className="inp"
                type={type}
                value={val}
        ...
        <p style={{textAlign:"center",marginTop:24,fontFamily:"'DM Sans',sans-serif",fontSize:12,color:"#3a3020",animation:"fadeUp 0.8s ease 0.4s both"}}>
